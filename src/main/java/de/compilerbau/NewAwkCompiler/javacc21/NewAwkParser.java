...
*/
    ...
    final public void MethodDecl() throws ParseException {
        ...
        try {
            ...
            if (resetScanAhead(1)&&first_set$NewAwkParser_jjt$line_222$column_6.contains(nextTokenType)) {
                // Code for NonTerminal specified on line 222 of NewAwkParser.jjt
                pushOntoCallStack("MethodDecl", "NewAwkParser.jjt", 222, 6);
                try {
                    Type();
                }
                finally {
                ...
                consumeToken(VOID);
                // Code for CodeBlock specified on line 222 of NewAwkParser.jjt
                MethodDecl5.isVoid= true;
            }
            else {
                pushOntoCallStack("MethodDecl", "NewAwkParser.jjt", 222, 6);
                throw new ParseException(currentToken.getNext(), first_set$NewAwkParser_jjt$line_222$column_6$, parsingStack);
            }
            ...
            pushOntoCallStack("MethodDecl", "NewAwkParser.jjt", 224, 19);
            try {
                ParameterList();
            }
            finally {
            ...
            // Code for NonTerminal specified on line 224 of NewAwkParser.jjt
            pushOntoCallStack("MethodDecl", "NewAwkParser.jjt", 224, 47);
            try {
                Block();
            }
            finally {
    ...
    final public void CompExpr() throws ParseException {
        ...
        try {
            ...
            while (resetScanAhead(1)&&first_set$NewAwkParser_jjt$line_276$column_11.contains(nextTokenType)) {
                ...
                // Code for NonTerminal specified on line 276 of NewAwkParser.jjt
                pushOntoCallStack("CompExpr", "NewAwkParser.jjt", 276, 81);
                try {
                    Sum();
                }
                finally {
...
*/
    ...
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_222$column_6$= EnumSet.of(VOID, TypeInt, TypeDouble, TypeChar, TypeBoolean, TypeString);
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_222$column_6= EnumSet.of(TypeInt, TypeDouble, TypeChar, TypeBoolean, TypeString);
    ...
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_276$column_11= EnumSet.of(NOT_EQUAL, G_OR_EQUAL, S_OR_EQUAL, GREATER, SMALLER);
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_276$column_13= EnumSet.of(NOT_EQUAL, G_OR_EQUAL, S_OR_EQUAL, GREATER, SMALLER);
