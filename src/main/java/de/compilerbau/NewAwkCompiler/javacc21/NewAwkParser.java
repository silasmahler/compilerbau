...
*/
    ...
    final public void MethodDecl() throws ParseException {
        ...
        try {
            ...
            if (resetScanAhead(1)&&first_set$NewAwkParser_jjt$line_239$column_6.contains(nextTokenType)) {
                // Code for NonTerminal specified on line 239 of NewAwkParser.jjt
                pushOntoCallStack("MethodDecl", "NewAwkParser.jjt", 239, 6);
                try {
                    Type();
                }
                finally {
                ...
                pushOntoCallStack("MethodDecl", "NewAwkParser.jjt", 239, 6);
                throw new ParseException(currentToken.getNext(), first_set$NewAwkParser_jjt$line_239$column_6$, parsingStack);
            }
            ...
            pushOntoCallStack("MethodDecl", "NewAwkParser.jjt", 242, 5);
            try {
                ParameterList();
            }
            finally {
            ...
            pushOntoCallStack("MethodDecl", "NewAwkParser.jjt", 243, 17);
            try {
                Block();
            }
            finally {
    ...
    final public void ParameterList() throws ParseException {
        ...
        try {
            ...
            if (resetScanAhead(1)&&first_set$NewAwkParser_jjt$line_246$column_5.contains(nextTokenType)) {
                // Code for NonTerminal specified on line 246 of NewAwkParser.jjt
                pushOntoCallStack("ParameterList", "NewAwkParser.jjt", 246, 6);
                try {
                    Type();
                }
                finally {
                ...
                while (resetScanAhead(1)&&nextTokenType== COMMA) {
                    ...
                    consumeToken(COMMA);
                    // Code for NonTerminal specified on line 246 of NewAwkParser.jjt
                    pushOntoCallStack("ParameterList", "NewAwkParser.jjt", 246, 52);
                    try {
                        Type();
                    }
                    finally {
...
*/
    ...
    final public void Atom() throws ParseException {
        ...
        try {
            ...
            if (resetScanAhead(2)&&check$NewAwkParser_jjt$line_298$column_6()) {
                // Code for NonTerminal specified on line 298 of NewAwkParser.jjt
                pushOntoCallStack("Atom", "NewAwkParser.jjt", 298, 19);
                try {
                    Cast();
                }
                finally {
            ...
            if (resetScanAhead(1)&&nextTokenType== ID) {
                // Code for ExpansionChoice specified on line 300 of NewAwkParser.jjt
                if (resetScanAhead(2)&&check$NewAwkParser_jjt$line_300$column_10()) {
                    // Code for NonTerminal specified on line 300 of NewAwkParser.jjt
                    pushOntoCallStack("Atom", "NewAwkParser.jjt", 300, 23);
                    try {
                        MethodCall();
                    }
                    finally {
                    ...
                    pushOntoCallStack("Atom", "NewAwkParser.jjt", 300, 10);
                    throw new ParseException(currentToken.getNext(), first_set$NewAwkParser_jjt$line_300$column_10, parsingStack);
                }
                // Code for ZeroOrOne specified on line 300 of NewAwkParser.jjt
                if (resetScanAhead(1)&&nextTokenType== ArrayAuf) {
                    // Code for NonTerminal specified on line 300 of NewAwkParser.jjt
                    pushOntoCallStack("Atom", "NewAwkParser.jjt", 300, 58);
                    try {
                        ArrayAccess();
                    }
                    finally {
                ...
                pushOntoCallStack("Atom", "NewAwkParser.jjt", 301, 24);
                try {
                    Expr();
                }
                finally {
                ...
                pushOntoCallStack("Atom", "NewAwkParser.jjt", 300, 9);
                throw new ParseException(currentToken.getNext(), first_set$NewAwkParser_jjt$line_300$column_9, parsingStack);
            }
    ...
    // NewAwkParser.jjt, line 306
    final public void Cast() throws ParseException {
        if (trace_enabled) LOGGER.info("Entering production defined on line 306 of NewAwkParser.jjt");
        if (cancelled) throw new CancellationException();
        ...
        try {
            ...
            pushOntoCallStack("Cast", "NewAwkParser.jjt", 307, 18);
            try {
                Type();
            }
            finally {
    ...
    final public void MethodCall() throws ParseException {
        ...
        try {
            ...
            if (resetScanAhead(1)&&first_set$NewAwkParser_jjt$line_312$column_5.contains(nextTokenType)) {
                // Code for NonTerminal specified on line 312 of NewAwkParser.jjt
                pushOntoCallStack("MethodCall", "NewAwkParser.jjt", 312, 6);
                try {
                    Expr();
                }
                finally {
                ...
                /*Add Arg*/
                // Code for ZeroOrMore specified on line 313 of NewAwkParser.jjt
                while (resetScanAhead(1)&&nextTokenType== COMMA) {
                    ...
                    pushOntoCallStack("MethodCall", "NewAwkParser.jjt", 313, 14);
                    try {
                        Expr();
                    }
                    finally {
    ...
    // NewAwkParser.jjt, line 316
    final public void ArrayAccess() throws ParseException {
        if (trace_enabled) LOGGER.info("Entering production defined on line 316 of NewAwkParser.jjt");
        if (cancelled) throw new CancellationException();
        ...
        try {
            ...
            // Code for NonTerminal specified on line 318 of NewAwkParser.jjt
            pushOntoCallStack("ArrayAccess", "NewAwkParser.jjt", 318, 16);
            try {
                Expr();
            }
            finally {
    ...
    final public void ArrayLength() throws ParseException {
        ...
        try {
            ...
            pushOntoCallStack("ArrayLength", "NewAwkParser.jjt", 323, 3);
            try {
                Expr();
            }
            finally {
    ...
    // NewAwkParser.jjt, line 325
    final public void Type() throws ParseException {
        if (trace_enabled) LOGGER.info("Entering production defined on line 325 of NewAwkParser.jjt");
        if (cancelled) throw new CancellationException();
        ...
        try {
            ...
            if (resetScanAhead(1)&&nextTokenType== TypeInt) {
                ...
                pushOntoCallStack("Type", "NewAwkParser.jjt", 329, 4);
                throw new ParseException(currentToken.getNext(), first_set$NewAwkParser_jjt$line_329$column_4, parsingStack);
            }
    ...
    final public void ReturnStmnt() throws ParseException {
        ...
        try {
            ...
            pushOntoCallStack("ReturnStmnt", "NewAwkParser.jjt", 343, 14);
            try {
                Expr();
            }
            finally {
    ...
    final public void KlammerAffe() throws ParseException {
        ...
        try {
            ...
            // Code for RegexpRef specified on line 347 of NewAwkParser.jjt
            consumeToken(BlockAuf);
            // Code for NonTerminal specified on line 348 of NewAwkParser.jjt
            pushOntoCallStack("KlammerAffe", "NewAwkParser.jjt", 348, 5);
            try {
                KlammerAffeRegex();
            }
            finally {
            ...
            // Code for NonTerminal specified on line 348 of NewAwkParser.jjt
            pushOntoCallStack("KlammerAffe", "NewAwkParser.jjt", 348, 24);
            try {
                KlammerAffeAusdruck();
            }
            finally {
            ...
            // Code for ZeroOrMore specified on line 349 of NewAwkParser.jjt
            while (resetScanAhead(1)&&nextTokenType== Colon||nextTokenType== ConditionalNot) {
                // Code for NonTerminal specified on line 349 of NewAwkParser.jjt
                pushOntoCallStack("KlammerAffe", "NewAwkParser.jjt", 349, 6);
                try {
                    KlammerAffeRegex();
                }
                finally {
                ...
                // Code for NonTerminal specified on line 349 of NewAwkParser.jjt
                pushOntoCallStack("KlammerAffe", "NewAwkParser.jjt", 349, 25);
                try {
                    KlammerAffeAusdruck();
                }
                finally {
    ...
    final public void KlammerAffeRegex() throws ParseException {
        ...
        try {
            // Code for ZeroOrOne specified on line 354 of NewAwkParser.jjt
            if (resetScanAhead(1)&&nextTokenType== ConditionalNot) {
            ...
            // Code for RegexpRef specified on line 354 of NewAwkParser.jjt
            consumeToken(Colon);
            // Code for ExpansionChoice specified on line 354 of NewAwkParser.jjt
            if (resetScanAhead(1)&&nextTokenType== INTEGER_CLASS) {
                ...
                pushOntoCallStack("KlammerAffeRegex", "NewAwkParser.jjt", 354, 33);
                throw new ParseException(currentToken.getNext(), first_set$NewAwkParser_jjt$line_354$column_33, parsingStack);
            }
            // Code for RegexpRef specified on line 354 of NewAwkParser.jjt
            consumeToken(Colon);
    ...
    final public void KlammerAffeAusdruck() throws ParseException {
        ...
        try {
            ...
            consumeToken(RETURN);
            // Code for ZeroOrOne specified on line 359 of NewAwkParser.jjt
            if (resetScanAhead(1)&&first_set$NewAwkParser_jjt$line_359$column_14.contains(nextTokenType)) {
                // Code for ExpansionChoice specified on line 359 of NewAwkParser.jjt
                if (resetScanAhead(1)&&nextTokenType== THIS) {
                    ...
                    pushOntoCallStack("KlammerAffeAusdruck", "NewAwkParser.jjt", 359, 16);
                    throw new ParseException(currentToken.getNext(), first_set$NewAwkParser_jjt$line_359$column_16, parsingStack);
                }
            }
            // Code for RegexpRef specified on line 359 of NewAwkParser.jjt
            consumeToken(SEMICOLON);
    ...
    final public void PrintStmnt() throws ParseException {
        ...
        try {
            // Code for ExpansionChoice specified on line 365 of NewAwkParser.jjt
            if (resetScanAhead(1)&&nextTokenType== PRINT_LINE) {
                ...
                pushOntoCallStack("PrintStmnt", "NewAwkParser.jjt", 365, 4);
                throw new ParseException(currentToken.getNext(), first_set$NewAwkParser_jjt$line_365$column_4, parsingStack);
            }
            // Code for RegexpRef specified on line 365 of NewAwkParser.jjt
            consumeToken(KlammerAuf);
            // Code for NonTerminal specified on line 365 of NewAwkParser.jjt
            pushOntoCallStack("PrintStmnt", "NewAwkParser.jjt", 365, 42);
            try {
                Expr();
            }
            finally {
    ...
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_239$column_6$= EnumSet.of(VOID, TypeInt, TypeDouble, TypeChar, TypeBoolean, TypeString);
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_239$column_6= EnumSet.of(TypeInt, TypeDouble, TypeChar, TypeBoolean, TypeString);
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_246$column_5= EnumSet.of(TypeInt, TypeDouble, TypeChar, TypeBoolean, TypeString);
    ...
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_300$column_9= EnumSet.of(NullLiteral, KlammerAuf, BooleanLiteral, CharLiteral, IntegerLiteral, DoubleLiteral, ID, StringLiteral);
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_300$column_10= EnumSet.of(ID);
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_312$column_5= EnumSet.of(PLUS, MINUS, ConditionalNot, NullLiteral, KlammerAuf, BooleanLiteral, CharLiteral, IntegerLiteral, DoubleLiteral, ID, StringLiteral);
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_329$column_4= EnumSet.of(TypeInt, TypeDouble, TypeChar, TypeBoolean, TypeString);
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_354$column_33= EnumSet.of(INTEGER_CLASS, DOUBLE_CLASS, CHAR_CLASS, BOOLEAN_CLASS, TypeString);
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_359$column_14= EnumSet.of(THIS, BooleanLiteral, CharLiteral, IntegerLiteral, DoubleLiteral);
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_359$column_16= EnumSet.of(THIS, BooleanLiteral, CharLiteral, IntegerLiteral, DoubleLiteral);
    static private final EnumSet<TokenType> first_set$NewAwkParser_jjt$line_365$column_4= EnumSet.of(PRINT_LINE, PRINT);
    ...
    private final boolean check$NewAwkParser_jjt$line_298$column_6() {
        if (remainingLookahead<=0) return true;
        pushOntoLookaheadStack("Atom", "NewAwkParser.jjt", 298, 19);
        if (!check$Cast()) {
            popLookaheadStack();
            return false;
        }
    ...
    private final boolean check$NewAwkParser_jjt$line_300$column_10() {
        if (remainingLookahead<=0) return true;
        pushOntoLookaheadStack("Atom", "NewAwkParser.jjt", 300, 23);
        if (!check$MethodCall()) {
            popLookaheadStack();
            return false;
        }
    ...
    private final boolean check$Cast() {
        ...
        pushOntoLookaheadStack("Cast", "NewAwkParser.jjt", 307, 18);
        stopAtScanLimit= false;
        if (!check$Type()) {
            popLookaheadStack();
            return false;
    ...
    private final boolean check$Type() {
        if (remainingLookahead<=0) return true;
        if (!scanToken(first_set$NewAwkParser_jjt$line_329$column_4)) return false;
        while (remainingLookahead> 0) {
            Token token23= currentLookaheadToken;
            if (!(check$NewAwkParser_jjt$line_334$column_3())) {
    ...
    private final boolean check$NewAwkParser_jjt$line_334$column_3() {
        if (remainingLookahead<=0) return true;
    ...
    private final boolean check$Atom() {
        ...
        if (!(check$NewAwkParser_jjt$line_298$column_6())) currentLookaheadToken= token26;
        Token token27= currentLookaheadToken;
        int remainingLookahead27= remainingLookahead;
        if (!(check$NewAwkParser_jjt$line_300$column_9())) {
            currentLookaheadToken= token27;
            remainingLookahead= remainingLookahead27;
            if (!(check$NewAwkParser_jjt$line_301$column_11())) {
                currentLookaheadToken= token27;
                remainingLookahead= remainingLookahead27;
    ...
    private final boolean check$NewAwkParser_jjt$line_300$column_9() {
        if (remainingLookahead<=0) return true;
        Token token28= currentLookaheadToken;
        int remainingLookahead28= remainingLookahead;
        if (!(check$NewAwkParser_jjt$line_300$column_10())) {
    ...
    private final boolean check$NewAwkParser_jjt$line_301$column_11() {
        if (remainingLookahead<=0) return true;
        if (!scanToken(KlammerAuf)) return false;
        return true;
    }
