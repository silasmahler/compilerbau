/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for NEXT_CHAR Token subclass
...
public class NEXT_CHAR extends Token {
    public NEXT_CHAR(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public NEXT_CHAR(TokenType type, String image, FileLineMap fileLineMap) {
