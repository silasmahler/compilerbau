...
public class Token implements NewAwkConstants, Node {
    ...
    public static Token newToken(TokenType type, String image, FileLineMap fileLineMap) {
        switch(type) {
            ...
            case INTEGER_CLASS:
            return new INTEGER_CLASS(TokenType.INTEGER_CLASS, image, fileLineMap);
            case DOUBLE_CLASS:
            return new DOUBLE_CLASS(TokenType.DOUBLE_CLASS, image, fileLineMap);
            case CHAR_CLASS:
            return new CHAR_CLASS(TokenType.CHAR_CLASS, image, fileLineMap);
            case BOOLEAN_CLASS:
            return new BOOLEAN_CLASS(TokenType.BOOLEAN_CLASS, image, fileLineMap);
            case KlammerAuf:
            ...
            case TypeInt:
            return new TypeInt(TokenType.TypeInt, image, fileLineMap);
            case TypeDouble:
            return new TypeDouble(TokenType.TypeDouble, image, fileLineMap);
            case TypeChar:
            return new TypeChar(TokenType.TypeChar, image, fileLineMap);
            case TypeBoolean:
            return new TypeBoolean(TokenType.TypeBoolean, image, fileLineMap);
            case TypeString:
            return new TypeString(TokenType.TypeString, image, fileLineMap);
            case BooleanLiteral:
            ...
            case PRINT_LINE:
            return new PRINT_LINE(TokenType.PRINT_LINE, image, fileLineMap);
            case PRINT:
            return new PRINT(TokenType.PRINT, image, fileLineMap);
            case LENGTH:
            return new LENGTH(TokenType.LENGTH, image, fileLineMap);
            default:
