/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for NEXT Token subclass
...
public class NEXT extends Token {
    public NEXT(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public NEXT(TokenType type, String image, FileLineMap fileLineMap) {
