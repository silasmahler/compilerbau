/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for DataType Token subclass
...
public class DataType extends Token {
    public DataType(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public DataType(TokenType type, String image, FileLineMap fileLineMap) {
