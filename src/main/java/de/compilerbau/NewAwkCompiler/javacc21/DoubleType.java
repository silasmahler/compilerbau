/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for DoubleType Token subclass
...
public class DoubleType extends Token {
    public DoubleType(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public DoubleType(TokenType type, String image, FileLineMap fileLineMap) {
