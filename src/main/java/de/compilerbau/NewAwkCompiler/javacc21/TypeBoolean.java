/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for TypeBoolean Token subclass
...
public class TypeBoolean extends Token {
    public TypeBoolean(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public TypeBoolean(TokenType type, String image, FileLineMap fileLineMap) {
