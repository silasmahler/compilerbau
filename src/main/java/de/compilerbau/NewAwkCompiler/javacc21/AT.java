/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for AT Token subclass
...
public class AT extends Token {
    public AT(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public AT(TokenType type, String image, FileLineMap fileLineMap) {
