/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for BooleanValue Token subclass
...
public class BooleanValue extends Token {
    public BooleanValue(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public BooleanValue(TokenType type, String image, FileLineMap fileLineMap) {
