/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for BOOLEAN_CLASS Token subclass
...
public class BOOLEAN_CLASS extends Token {
    public BOOLEAN_CLASS(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public BOOLEAN_CLASS(TokenType type, String image, FileLineMap fileLineMap) {
