/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for INTEGER_CLASS Token subclass
...
public class INTEGER_CLASS extends Token {
    public INTEGER_CLASS(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public INTEGER_CLASS(TokenType type, String image, FileLineMap fileLineMap) {
