/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for BEGIN Token subclass
...
public class BEGIN extends Token {
    public BEGIN(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public BEGIN(TokenType type, String image, FileLineMap fileLineMap) {
