/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for S_OR_EQUAL Token subclass
...
public class S_OR_EQUAL extends Token {
    public S_OR_EQUAL(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public S_OR_EQUAL(TokenType type, String image, FileLineMap fileLineMap) {
