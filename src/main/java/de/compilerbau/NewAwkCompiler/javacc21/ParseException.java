...
public class ParseException extends Exception implements NewAwkConstants {
    ...
    private List<NewAwkParser.NonTerminalCall> callStack;
    private boolean alreadyAdjusted;
    public ParseException() {
        super();
    }

    public ParseException(Token token, EnumSet<TokenType> expectedTypes, List<NewAwkParser.NonTerminalCall> callStack) {
        this.token= token;
        this.expectedTypes= expectedTypes;
        this.callStack= new ArrayList<> (callStack);
    }

    public ParseException(NewAwkParser parser, String message) {
        super(message);
    ...
    private void adjustStackTrace() {
        ...
        for (NewAwkParser.NonTerminalCall ntc : callStack) {
