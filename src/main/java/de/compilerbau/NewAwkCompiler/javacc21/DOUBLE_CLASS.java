/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for DOUBLE_CLASS Token subclass
...
public class DOUBLE_CLASS extends Token {
    public DOUBLE_CLASS(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public DOUBLE_CLASS(TokenType type, String image, FileLineMap fileLineMap) {
