/* Generated by: JavaCC 21 Parser Generator. Do not edit. 
  * Generated Code for PRINT Token subclass
...
public class PRINT extends Token {
    public PRINT(TokenType type, String image, String inputSource) {
        super(type, image, inputSource);
    }

    public PRINT(TokenType type, String image, FileLineMap fileLineMap) {
